# The name of this view in Looker is "T Covid19 Us States Tests Rearc"
view: t_covid19_us_states_tests_rearc {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `thesis.t_covid19_us_states_tests_rearc`
    ;;
  ...
  # This dimension will be called "Data Quality Grade" in Explore.
